      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <hr class="mt-4 mb-4" />
            <h4 class="pb-3  m-b-0">Billing Information</h4>
      ...
      <div class="col-xl-12">
        <div class="card">
          <div class="card-header">
            <h3>Inline Form</h3>
            <span
              >Use<code>.form-inline</code>class in the form to style with
              inline fields.</span
            >
          </div>
          <div class="card-body">
            ...
            <form class="row theme-form mt-3">
              <div class="col-xxl-4 mb-3 d-flex">
                <label
                  class="col-form-label pe-2"
                  for="inputInlineUsername"
                  >Username</label
                >
                <input
                  class="form-control"
