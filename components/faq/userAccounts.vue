<template>
  ...
  <div class="card">
    <div class="card-header">
      <h5 class=" m-b-0">
        <button
          ...
          v-on:click="toggle"
        >
          <vue-feather type="help-circle"></vue-feather>Integrating WordPress
          with Your Website ?
        </button>
      </h5>
    </div>
    ...
    >
      <div class="card-body">
        <p>
          How you approach this process will depend on which web host you use.
          For example, a lot of hosting providers use cPanel, which includes an
          option to set up subdomains with just a few clicks.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    ...
    >
      <div class="card-body">
        <p>
          As of version 4.0, you can have WordPress automatically install the
          language of your choice during the installation process.
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="card-header">
      <h5 class=" m-b-0">
        <button
          ...
          v-on:click="toggle"
        >
          <vue-feather type="help-circle"></vue-feather> Validating a Website ?
        </button>
      </h5>
    </div>
    <div
  ...
  <div class="card">
    ...
    >
      <div class="card-body">
        <p>
          Manually adding meta tags in WordPress is relatively simple. For this
          demo, we’ll use the example from the WordPress Codex. Imagine you’re
          Harriet Smith, a veterinarian who blogs about their animal stories on
          WordPress.
        </p>
      </div>
    </div>
