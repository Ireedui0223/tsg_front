<template>
  <div class="col-lg-12">
    <div class="header-faq">
      <h5 class=" m-b-0">Featured Tutorials</h5>
    </div>
    <div class="row">
      <div class="col-xxl-3 col-md-6 box-col-6">
        <div class="card features-faq product-box">
          ...
          <div class="card-body">
            <h6>Web Design</h6>
            <p>
              A Web Designing course belongs to the field of Computer Science
              and IT. It enables students to learn various techniques.
            </p>
          </div>
      ...
      <div class="col-xxl-3 col-md-6 box-col-6">
        <div class="card features-faq product-box">
          ...
          <div class="card-body">
            ...
            <p>
              This course is designed to start you on a path toward future
              studies in web development and design.
            </p>
          </div>
          <div class="card-footer">
      ...
      <div class="col-xxl-3 col-md-6 box-col-6">
        <div class="card features-faq product-box">
          ...
          <div class="card-body">
            <h6>UI Design</h6>
            <p>
              User interface design (UI) is the design for machines and
              software, such as mobile devices, computers.
            </p>
          </div>
          <div class="card-footer">
