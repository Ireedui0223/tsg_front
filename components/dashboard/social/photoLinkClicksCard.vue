        ...
        <div class="card click-widgets widget-hover">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-around">
              ...
              <div>
                <h4 class=" m-b-0">%76</h4>
                <span class="f-light d-block my-1">Photo Clicks</span
                ><span class="font-success">+72.9%</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card click-widgets widget-hover">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-around">
              ...
              <div>
                <h4 class=" m-b-0">%89</h4>
                <span class="f-light d-block my-1">Link Clicks</span
                ><span class="font-secondary">79.9%</span>
              </div>
            </div>
          </div>
        </div>
