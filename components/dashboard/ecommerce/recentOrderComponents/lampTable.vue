        ...
        <tr>
          <td>
            <div class="product-content">
              <div class="order-image">
                <img
                  src="/images/dashboard-2/order/sub-product/9.png"
                  alt="lamp"
                />
              </div>
              <div>
          ...
          <td class="f-w-500">
            <div class="recent-status font-success">
              <svg class="me-1">
                <use href="@/assets/svg/icon-sprite.svg#24-hour"></use></svg
              >Verified
            </div>
          </td>
        ...
        <tr>
          <td>
            <div class="product-content">
              <div class="order-image">
                <img
                  src="/images/dashboard-2/order/sub-product/10.png"
                  alt="lamp"
                />
              </div>
              <div>
                <h6 class="f-14  m-b-0">
                  <a>
                    <NuxtLink to="/ecommerce/order/history"
                      >Bedside lamp</NuxtLink
                    >
                  </a>
                </h6>
