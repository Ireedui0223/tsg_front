<template>
  <div class="col-sm-12 col-xl-6 xl-100">
    <div class="card">
      ...
      <div class="card-body">
        ...
        >
          <li class="nav-item">
            <a
              ...
              id="pills-warninghome-tab"
              data-bs-toggle="pill"
              href="#pills-warninghome"
              role="tab"
              aria-controls="pills-warninghome"
              aria-selected="true"
        ...
        <div
          class="tab-content"
          id="pills-warningtabContent"
        >
          <div
            class="tab-pane fade show active"
            id="pills-warninghome"
            role="tabpanel"
      ...
      <div class="card-body">
        ...
        >
          <li class="nav-item">
            <a
              class="nav-link active"
              id="pills-successhome-tab"
              data-bs-toggle="pill"
              href="#pills-successhome"
              role="tab"
              aria-controls="pills-successhome"
              aria-selected="true"
              ><i class="icofont icofont-ui-home"></i>Home</a
            >
          </li>
          <li class="nav-item">
            <a
              class="nav-link"
              id="pills-successprofile-tab"
              data-bs-toggle="pill"
              href="#pills-successprofile"
              role="tab"
              aria-controls="pills-successprofile"
              aria-selected="false"
              ><i class="icofont icofont-man-in-glasses"></i>Profile</a
            >
          </li>
          <li class="nav-item">
            <a
              class="nav-link"
              id="pills-successcontact-tab"
              data-bs-toggle="pill"
              href="#pills-successcontact"
              role="tab"
              aria-controls="pills-successcontact"
              aria-selected="false"
              ><i class="icofont icofont-contacts"></i>Contact</a
            >
          </li>
        ...
        <div
          class="tab-content"
          id="pills-successtabContent"
        >
          <div
            class="tab-pane fade show active"
            id="pills-successhome"
            role="tabpanel"
  ...
  <div class="col-sm-12 col-xl-6 xl-100">
    <div class="card">
      ...
      <div class="card-body">
        <ul
          class="nav nav-pills nav-success"
          id="pills-clrtab"
          role="tablist"
        >
          <li class="nav-item">
