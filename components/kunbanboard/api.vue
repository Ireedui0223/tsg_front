  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <h3>API</h3>
        <p class=" m-b-0">add item, add board, delete board:</p>
      </div>
      <div class="card-body">
        <div id="demo3">
          <div
                  ...
                  >
                    ...
                    >
                      <a
                        ...
                        <img
                          v-if="task.imagee == 'done'"
                          class="mt-2 img-fluid"
                          src="/images/other-images/sidebar-bg.jpg"
                          alt=""
                          data-original-title=""
                          title=""
                        />
                        <img
                          v-if="task.imagee == 'working'"
                          class="mt-2 img-fluid"
                          src="https://t3.ftcdn.net/jpg/01/59/72/46/360_F_159724657_pTBbBhM4JOgcxO608MLSRPBy1ZYH5qPk.jpg"
                          alt=""
                          data-original-title=""
                          title=""
                        />
...
<script>
import { columns } from '@/data/kanban/kanban.json';
