  ...
  <div class="col-sm-12 col-xxl-6 box-col-12">
    <div class="card height-equal">
      <div class="card-header">
        ...
        <span
          >For Create inline megaoption add <code>.mega-horizontal</code> class
          in form tag</span
        >
      </div>
      <div class="card-body">
                ...
                <div class="d-flex p-20">
                  ...
                  <div class="flex-grow-1">
                    <h6 class="mt-0 mega-title-badge">
                      COD<span class="badge badge-primary pull-right digits"
                        >50 INR</span
                      >
                    </h6>
                    <p>
                      Estimated 5 Day Shipping ( Duties end tax may be due
                      delivery )
                    </p>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="d-flex p-20">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <p>
                      Estimated 1 Day Shipping ( Duties end tax may be due
                      delivery )
                    </p>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="d-flex p-20">
                  ...
                  <div class="flex-grow-1">
                    <h6 class="mt-0 mega-title-badge">
                      XYZ Seller<span
                        class="badge badge-success pull-right digits"
                        >250 INR</span
                      >
                    </h6>
                    <p class="rating-star-wrapper">
                      <i class="icofont icofont-star txt-warning"></i
                      ><i class="icofont icofont-star txt-warning"></i
                      ><i class="icofont icofont-star txt-warning"></i
                      ><i class="icofont icofont-star txt-warning"></i
                      ><i class="icofont icofont-star txt-warning m-r-5"></i>5
                      start rating
                    </p>
                  </div>
                </div>
            ...
            <div class="col-sm-9 offset-sm-3">
              <div class="card  m-b-0">
                <div class="d-flex p-20">
                  ...
                  <div class="flex-grow-1">
                    <h6 class="mt-0 mega-title-badge">
                      ABC Seller<span class="badge badge-info pull-right digits"
                        >150 INR</span
                      >
                    </h6>
                    <p class="rating-star-wrapper">
