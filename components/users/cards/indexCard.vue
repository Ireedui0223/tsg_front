        ...
        <div class="card social-profile">
          <div class="card-body">
            ...
            <div class="social-details">
              <h5 class="mb-1">
                <a href="social-app.html">{{ friend.name }}</a>
              </h5>
              <span class="f-light">{{ friend.email }}</span>
              ...
              <ul class="social-follow">
                <li>
                  <h5 class=" m-b-0">{{ friend.totalPost }}</h5>
                  <span class="f-light">Posts</span>
                </li>
                <li>
                  <h5 class=" m-b-0">{{ friend.follower }}</h5>
                  <span class="f-light">Followers</span>
                </li>
                <li>
                  <h5 class=" m-b-0">{{ friend.following }}</h5>
